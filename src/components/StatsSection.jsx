...
export default function StatsSection() {
    ...
    return (
        <section className="relative overflow-hidden bg-black py-28 text-white">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-6 mt-25">
                {/* Heading */}
                <div className="mx-auto max-w-3xl text-center">
                    <h2 className="text-2xl md:text-3xl leading-relaxed text-white/90">
                        Assisting over <span className="text-4xl">15,000</span> job seekers
                        <br />
