        ...
        <nav className="sticky top-0 z-50 border-b border-white/10 bg-[#0B0B0F]/80 backdrop-blur-xl">
            <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-4">
                    {/* Desktop Menu */}
                    <div className="hidden items-center gap-6 md:flex rounded-2xl border border-white/10 bg-white/5 px-3 py-2">
                        {/* Nav Links */}
                                ...
                                user ?
                                    ...
                                    <>
                                        ...
                                        <Link href="/auth/signup">
                                            <Button
                                                radius="lg"
                                                className="h-11 bg-white px-6 text-sm font-semibold rounded-2xl text-black hover:bg-gray-200"
                                            >
                                                Get Started
                                            </Button>
                                        </Link>
