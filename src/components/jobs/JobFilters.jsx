            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                ...
                <div className="md:col-span-5">
                    <TextField
                        ...
                        className="w-full"
                    // onChange={(e) => setSearchQuery(e.target.value)} wont work because hero ui TextField onchange works with direct value
                    >
                    ...
                    >
                        ...
                        <Select.Popover className="bg-zinc-800 border border-zinc-700 rounded-xl shadow-xl mt-1 overflow-hidden z-50">
                            <ListBox className="p-1">
                                ...
                                <ListBox.Item id="marketing" className="text-zinc-200 hover:bg-purple-600 hover:text-white rounded-lg px-3 py-2 text-sm cursor-pointer capitalize">
                                    <span>Marketing</span>
                                </ListBox.Item>
                                <ListBox.Item id="business" className="text-zinc-200 hover:bg-purple-600 hover:text-white rounded-lg px-3 py-2 text-sm cursor-pointer capitalize">
                                    <span>Business</span>
                                </ListBox.Item>
                                <ListBox.Item id="data" className="text-zinc-200 hover:bg-purple-600 hover:text-white rounded-lg px-3 py-2 text-sm cursor-pointer capitalize">
                                    <span>Data</span>
                                </ListBox.Item>
                            </ListBox>
                        </Select.Popover>
